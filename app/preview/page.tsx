...
export default async function PreviewPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-10 px-4 py-12">
      ...
      {/* The page answered "what is it worth". The next step is the landing win:
          three commands. Not the /start questionnaire, which asks for a wallet. */}
      <section className="rounded-lg border border-amber-500/30 bg-amber-500/5 p-6">
        ...
        <p className="mt-2 text-sm leading-relaxed text-neutral-400">
          Nothing above required an account. The next step is three commands.
        </p>
        <Link
          href="/"

import { constructPaymentAndSign, OutboundPaymentPayload } from './x402-payment';
...
export class X402Client {
     ...
     */
    async constructPayment(challenge: any): Promise<OutboundPaymentPayload> {
...
export async function escrowWithPaymentFlow(opts: EscrowOptions): Promise<any> {
    const engineUrl = opts.engineUrl || 'https://repid-engine-production.up.railway.app';

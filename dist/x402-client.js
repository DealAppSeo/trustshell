...
class X402Client {
    ...
    async constructPayment(challenge) {
        return (0, x402_payment_1.constructPaymentAndSign)(challenge, this.walletPrivateKey, this.rpcUrl);
    }
}
exports.X402Client = X402Client;
async function payAndEscrow(opts) {
    const payment = await (0, x402_payment_1.constructPaymentAndSign)(opts.facilitatorChallenge, opts.privateKey, opts.rpcUrl);
